    ...
    const cardsData = [                                                                   //Creamos un Objeto donde Objeto representara una Card 
        {
            ...
            caracteristicas: [
                ...
                { classNameIcono: 'bi bi-check text-primary', descripcion: 'Plantillas Personalizables', destacada: false},
                ...
                { classNameIcono: 'bi bi-x', descripcion: 'Envío y Seguimiento', destacada: true},   
                ...
                { classNameIcono: 'bi bi-x', descripcion: 'Seguridad Avanzada', destacada: true},   
                { classNameIcono: 'bi bi-x', descripcion: 'Escalabilidad', destacada: true},   
                { classNameIcono: 'bi bi-x', descripcion: 'Soporte Prioritario', destacada: true},   
                { classNameIcono: 'bi bi-x', descripcion: 'Personalización Completa', destacada: true},   
        ...
        },
        {
            ...
            caracteristicas: [
                ...
                { classNameIcono: 'bi bi-check text-primary', descripcion: 'Envío y Seguimiento', destacada: false},   
        ...
        },
        {
            ...
            caracteristicas: [
                ...
                { classNameIcono: 'bi bi-check text-primary', descripcion: 'Seguridad Avanzada', destacada: false},   
                { classNameIcono: 'bi bi-check text-primary', descripcion: 'Escalabilidad', destacada: false},   
                { classNameIcono: 'bi bi-check text-primary', descripcion: 'Soporte Prioritario', destacada: false},   
                { classNameIcono: 'bi bi-check text-primary', descripcion: 'Personalización Completa', destacada: false},   
