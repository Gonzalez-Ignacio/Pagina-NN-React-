    ...
    <>
        <section className="py-5">
            <div className="container d-flex justify-content-center align-items-center px-3">
                ...
                <div className="card bg-light bg-violeta-negro rounded-3 py-5 mb-5 mt-5 col-12 col-sm-10 col-md-8 col-lg-6 col-xl-4">
                    <div className="text-center mt-4 mb-4 mx-5">
                        {/* <div className="feature bg-morado bg-gradient text-white rounded-3 mb-3"><i className="bi bi-envelope"></i></div> */}
                        <h1 className="fw-bolder text-white">Iniciar Sesión</h1>
                    </div>
                    <div className="row gx-3 justify-content-center mb-2">
