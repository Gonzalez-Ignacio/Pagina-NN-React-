...
export function Politicas() {
    return (
        <div className="container mt-3 mb-3">
            ...
            mejor servicio web. También usted puede cambiar la configuración de
            su ordenador para declinar las cookies. Si se declinan es posible
            ...
            <br></br>
            <br></br>Esta compañía no venderá, cederá ni distribuirá la
            información personal que es recopilada sin su consentimiento, salvo
            que sea requerido por un juez con un orden judicial.
            <br></br>
            <br></br>
            NN Servicios Web Se reserva el derecho de cambiar los términos de la
