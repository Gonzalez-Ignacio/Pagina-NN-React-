...
export function Politicas() {
    return (
        <div>
            ...
            El presente Política de Privacidad establece los términos en que NN
            Servicios Web usa y protege la información que es proporcionada por
            ...
            dichos cambios. \n
            Información que es recogida Nuestro sitio web podrá
            ...
            NN Servicios Web está altamente comprometido para cumplir con el
            ...
            no exista ningún acceso no autorizado. Cookies Una cookie se refiere
            a un fichero que es enviado con la finalidad de solicitar permiso
            para almacenarse en su ordenador, al aceptar dicho fichero se crea y
            la cookie sirve entonces para tener información respecto al tráfico
            ...
            servicios. Enlaces a Terceros Este sitio web pudiera contener en
            laces a otros sitios que pudieran ser de su interés. Una vez que
            usted de clic en estos enlaces y abandone nuestra página, ya no
            tenemos control sobre al sitio al que es redirigido y por lo tanto
            ...
            acuerdo con estas. Control de su información personal En cualquier
            momento usted puede restringir la recopilación o el uso de la
            ...
            usuario, puede marcar o desmarcar la opción de recibir información
            por correo electrónico. En caso de que haya marcado la opción de
            recibir nuestro boletín o publicidad usted puede cancelarla en
            cualquier momento. Esta compañía no venderá, cederá ni distribuirá
            la información personal que es recopilada sin su consentimiento,
            salvo que sea requerido por un juez con un orden judicial. NN
            Servicios Web Se reserva el derecho de cambiar los términos de la
